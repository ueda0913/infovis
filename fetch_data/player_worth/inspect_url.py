...
url_ng3 = 'https://www.transfermarkt.jp/fabian-orellana/profil/spieler/60890'
...
content_ng3 = requests.get(url_ng3, headers = header).text
#%%
print(content_ng3)
#%%
...
info_included_ng3 =  [line.rstrip() for line in content_ng3.split('\n') if 'series' in line][-2]
print(info_included_ok)
print('******')
# print(info_included_ng)
print(info_included_ng3)
#%%
info_included = info_included_ng3
